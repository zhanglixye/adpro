<template>
    <div :class="[layout == 1?'flex_column':'flex_row']">
        <div v-for="(item,index) in list" :key="index" style="padding:0" :class="[fold === true?'ml-5':'']">
            <v-layout row justify-center>
                <v-flex xs10 class="checkbox_reduce">
            ...
            <tree :fold="foldBool" :layout="item.layout" :status-bool="statusBool" v-if="scopes[index]" :list="item.components" :ajaxPath="ajaxPath" :axios="axios" :loadingDisplay="loadingDisplay"></tree>
        </div>
