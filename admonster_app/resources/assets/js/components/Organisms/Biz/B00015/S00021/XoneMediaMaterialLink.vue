    ...
    methods: {
        ...
        async unKnowEvent() {
            try {
                ...
                G00000_1.G00000_35.C00700_36 = this.$refs.dateBuss.$data.user_start_date===''?null:this.$refs.dateBuss.$data.user_start_date + ' '+ this.$refs.dateBuss.$data.user_start_time+':00';
                G00000_1.G00000_35.C00700_37 = this.$refs.dateBuss.$data.user_end_date===''?null:this.$refs.dateBuss.$data.user_end_date + ' ' + this.$refs.dateBuss.$data.user_end_time+':00';
                G00000_1.G00000_35.C00100_38 = Number(this.$refs.dateBuss.$data.user_timekeeping/60).toFixed(2);
                G00000_1.G00000_35.C00100_39 = this.$refs.dateBuss.$data.remark;
