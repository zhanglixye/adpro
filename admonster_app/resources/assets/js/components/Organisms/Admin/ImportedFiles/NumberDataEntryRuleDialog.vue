...
export default {
    ...
    data () {
        return {
            ...
            beforeSelectedCheckBoxItems: [],
            selectedAlignItem: _const.DISPLAY_FORMAT.COMMON_ALIGN_RIGHT,
            beforeSelectedAlignItem: _const.DISPLAY_FORMAT.COMMON_ALIGN_RIGHT,
            index: null,
    ...
    computed: {
        checkBoxItems () {
            ...
            for (const [displayFormatKey, displayFormatValue] of Object.entries(_const.DISPLAY_FORMAT)) {
                ...
                if (!['COMMON', 'NUM'].includes(displayFormatKey.substr(0, end)) || displayFormatKey.match(/COMMON_ALIGN/g)) continue
                displayFormats.push(
                    {
        ...
        form () {
            ...
            return {
                ...
                displayRule: this.selectedCheckBoxItems.concat(selectedValues)
            }
        }
    },
    methods: {
        ...
        show (index, form) {
            if (form !== undefined && form['selectType'] === this.dataType) {
                ...
                // alignが選択されているか確認
                if (this.alignItems.some(alignItem => displayRule.includes(alignItem.id))) {
                ...
                this.selectedCheckBoxItems = displayRule // 残りを設定
