        ...
        <div v-if="isShow" class="elevation-1">
            ...
            <div id="request-content-main">
                <before-delivery
                    ...
                    :screen-template="screenTemplateForBeforeWork"
                ></before-delivery>
                <mail-view
                    :max-height="contentMaxHeight"
                    :min-height="contentMinHeight"
                    ...
                    :screen-template="screenTemplateForMail"
                ></mail-view>
                <request-file
                    :request-file="request.request_file"
                    ...
                    :min-height="contentMinHeight"
                    :height="contentHeight"
                    :screen-template="screenTemplateForFile"
                ></request-file>
            </div>
        </div>
        <appendices-index
...
export default {
    ...
    computed: {
        ...
        screenTemplate () {
            return this.initData ? JSON.parse(this.initData['screen_template']) : null
        },
        screenTemplateForMail () {
            return this.screenTemplate && 'mail' in this.screenTemplate ? this.screenTemplate['mail'] : null
        },
        screenTemplateForFile () {
            return this.screenTemplate && 'file' in this.screenTemplate ? this.screenTemplate['file'] : null
        },
        screenTemplateForBeforeWork () {
            return this.screenTemplate && 'before_work' in this.screenTemplate ? this.screenTemplate['before_work'] : null
        },
        sendMail () {
        ...
        //         workDetailLinks.push({ title: Vue.i18n.translate('common.request_content.information.request_detail_confirm'), icon: 'mdi-text-box-multiple', href: '/requests/' + this.request['id'] })
        //         workDetailLinks.push({ title: Vue.i18n.translate('common.request_content.information.work_detail_confirm'), icon: 'mdi-text-box', href: '/request_works/' + this.request['request_work_id'] })
        //     }
