...
<script>
import LineAcquireInformationList from '../../../Organisms/Biz/B00017/S00023/LineAcquireInformationList';
import LineAcquireInformationInput from '../../../Organisms/Biz/B00017/S00023/LineAcquireInformationInput';
    ...
    methods: {
        ...
        axiosFormData() {
            ...
            content.G00000_3.forEach((item)=>{
                ...
                item.C00700_4 = item.C00700_4 == null ? null : item.C00700_4.replace(/-/g,'/');
