    ...
    methods:{
        ...
        getAllComponentData:function () {
            ...
            dataTemplate.common_work_time = {
                started_at: this.$refs.abbeyList.$refs.dateBuss.$data.user_start_date === '' ? null : this.$refs.abbeyList.$refs.dateBuss.$data.user_start_date + ' ' + this.$refs.abbeyList.$refs.dateBuss.$data.user_start_time + ':00',
                finished_at: this.$refs.abbeyList.$refs.dateBuss.$data.user_end_date === '' ? null : this.$refs.abbeyList.$refs.dateBuss.$data.user_end_date + ' ' + this.$refs.abbeyList.$refs.dateBuss.$data.user_end_time + ':00',
                total: Number(this.$refs.abbeyList.$refs.dateBuss.$data.user_timekeeping/60).toFixed(2),
                remark: this.$refs.abbeyList.$refs.dateBuss.$data.remark,
            };
