<template>
    <div>
        ...
        ></email-deal>
        <!-- 经费承认-->
        <read-deal-recognize ref="readRecognize" :axiosFormData="axiosFormData" style="overflow: hidden auto;"
                             @emailSend="emailSend" :data="readRecoginceData" @changeEmail="changeEmail"
                             v-show="!flag_business_rec"></read-deal-recognize>
