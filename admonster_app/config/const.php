...
return [
    ...
    'DISPLAY_FORMAT' => [
        ...
        'COMMON_ALIGN_LEFT'=> 2,
        'COMMON_ALIGN_CENTER' => 4,
        'COMMON_ALIGN_RIGHT' => 8,
    ],
    'TO_ORDER_DETAIL' => [
        'VALUE_TYPE' => [
            'DIRECT' => 0, // 直接
            'TASK_RESULT' => 1, // 作業内容から取得
            'SYSTEM_TIME' => 2, // システム時間
            'REQUEST_WORK_CODE' => 3, // request_works.codeから取得
        ],
        'ITEM_TYPE' => [
            'ORDER_DETAIL_COLUMN' => 0, // 案件明細の項目
            'CUSTOM_STATUS' => 1, // カスタムステータス名
            'SYSTEM_COLUMN' => 2, // システム項目
        ],
        'SYSTEM_TYPE' => [
            'STATUS' => 0, // ステータス
        ],
