...
class B00017Seeder extends Seeder
{
    /**
     * Run the database seeds.
     * Command: php artisan db:seed --class=B00017Seeder
     *
     * @return void
     */
    public function run()
    {
        ...
        $steps = [
            [
                'id' => 23,  // ◆ 作業ID
                'name' => 'キャプチャ取得(タイムライン)',  // ◆ 作業名
                'description' => '対象アカウントのメッセージのADとLPをキャプチャ取得する',  // ◆ 作業の説明
                'next_id' => 27,  // ◆ 次に続く作業があれば次の作業ID、無ければnull
                ...
                'item_configs' => [
                    ...
                    "G00000_1" => [
                        ...
                        "layout_option" => '{"layout":1,' .
                            ' "urls": [{' .
                            ' "label": "マニュアルを参照する",' .
                            ' "url": "manuals/B00017/S00027/マニュアルを参照する.pdf"' .
                            ' }]' .
                            '}',
                    ...
                    "C01000_8" => [
                        ...
                        "is_required" => 0,
                        "parent_id" => 'G00000_7',
                        "layout_option" => '{"value":"manuals/B00017/S00027/ADが長くて1列におさまらない.pdf"}',
                        "validate_option" => null
                    ],
                    "C01000_9" => [
                        ...
                        "is_required" => 0,
                        "parent_id" => 'G00000_7',
                        "layout_option" => '{"value":"manuals/B00017/S00027/LPが多くスライドが2枚以上になる.pdf"}',
                        "validate_option" => null
                    ],
                    "C01000_10" => [
                        "label" => '・新規追加アカウントの場合',
                        ...
                        "is_required" => 0,
                        "parent_id" => 'G00000_7',
                        "layout_option" => '{"value":"manuals/B00017/S00027/新規追加アカウントの場合.pdf"}',
                        "validate_option" => null
                    ],
                    "C00400_11" => [
                        "label" => 'マニュアルを確認しました',
