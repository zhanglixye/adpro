    ...
    public function run()
    {
        ...
        $steps = [
                ...
                'item_configs' => [
                    ...
                    "G00000_1/C00100_3" => [
                        ...
                        "use_screen" => pow(2, \Config::get('const.PROCESS_TYPE.WORK'))
                            + pow(2, \Config::get('const.PROCESS_TYPE.APPROVAL'))
                    ...
                    "C00800_24/C00800_25" => [
                        "label" => "『★交通費(AP)メール』シート",
                        "type" => 800,
                        "sort" => 25,
                    ],
                    "C00800_24/C00800_26" => [
                        "label" => "『★交通費(常駐)メール』シート",
                        "type" => 800,
                        "sort" => 26,
                    ],
                    "G00000_27" => [
                    ...
                    "checklist/G00000_27/G00000_33/0/items/0" => [
                        "label" => "メール本文に記載されている社員番号、申請者名、金額に問題はありません",
                        "type" => 400,
                        "sort" => 102,
                        "values" => [
            ...
            [
                ...
                'end_criteria' => 0,
                'is_send_task_req_mail' => \Config::get('const.FLG.INACTIVE'),
                'request_screen_template' => '{"before_work":{"header":"<div style=\"padding: 8px;\">ご担当者様<br>ご対応をお願いいたします。</div>","footer":"<div style=\"padding: 8px;\">以上、よろしくお願いいたします。</div>"}}',  // 依頼内容の画面テンプレート
                'allocation_parallel' => 1,
                'allocation_method' => 2,
                'approval_conditions' => 1,
