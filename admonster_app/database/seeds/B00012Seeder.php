            ...
            [
                ...
                'to_order_detail' => [
                    "order_details" => [
                        ...
                        [
                            ...
                            "item_type" => 0,
                            "value_type" => 1,
                            "value" => "checklist/G00000_27/G00000_33/0/items/0",
                            "ignore_empty_string" => false,
                            "conditions" => 0
                        ],
                        [
                ...
                'item_configs' => [
                    ...
                    "checklist/G00000_27/G00000_33/1" => [
                        "label" => "２．媒体資料をAGに登録（紐づけ）しましたか？　 ※社外秘資料は紐づけ不可！",
                        "type" => 0,
                        "sort" => 102,
                        "use_screen" => pow(2, \Config::get('const.PROCESS_TYPE.WORK')),
                        "is_required" => 0,
                    ...
                    "checklist/G00000_27/G00000_33/2" => [
                        "label" => "2‐1. 紐づけたデバイスにチェックを入れてください",
                        "type" => 0,
                        "sort" => 112,
                        "use_screen" => pow(2, \Config::get('const.PROCESS_TYPE.WORK')),
                        "is_required" => 0,
                    ...
                    "checklist/G00000_27/G00000_33/2/items/0" => [
                        ...
                        "is_required" => 1,
                        "parent_id" => 'checklist/G00000_27/G00000_33/2',
                        "layout_option" => null,
                        "validate_option" => null
                    ],
                    ...
                    "checklist/G00000_27/G00000_33/3" => [
                        "label" => "2‐2.前Q資料の確認・対応をしましたか？",
                        "type" => 0,
                        "sort" => 126,
                        "use_screen" => pow(2, \Config::get('const.PROCESS_TYPE.WORK')),
                        "is_required" => 0,
                    ...
                    "checklist/G00000_27/G00000_33/3/items/0" => [
                        ...
                        "is_required" => 1,
                        "parent_id" => 'checklist/G00000_27/G00000_33/3',
                        "layout_option" => null,
                        "validate_option" => null
                    ],
                    "checklist/G00000_27/G00000_33/4" => [
                        "label" => "３．メールにチェックリストのboxURLの記述がありますか？",
                        "type" => 0,
                        "sort" => 131,
                        "use_screen" => pow(2, \Config::get('const.PROCESS_TYPE.WORK')),
                        "is_required" => 0,
                    ...
                    "checklist/G00000_27/G00000_33/4/items/0" => [
                        ...
                        "is_required" => 1,
                        "parent_id" => 'checklist/G00000_27/G00000_33/4',
                        "layout_option" => null,
                        "validate_option" => null
                    ],
                ],
