...
namespace App\Services\CommonMail\Replay\Biz\B00022;
...
class S00029Impl extends GenericImpl
{
    /**
     * 获取默认的本文.
...
//        #{before_mail_body}
        ...
        // 获取模板
        $template_config_array = \Config::get("biz.b00022.MAIL_CONFIG.s00029.MAIL_REPLAY_BODY_TEMPLATE");
