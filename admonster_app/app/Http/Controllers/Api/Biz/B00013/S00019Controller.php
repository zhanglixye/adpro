...
class S00019Controller extends MailController
{
    ...
    public function process(string $last_displayed_page, array $data, int $task_result_type): array
    {
        ...
        try {
            ...
            $work_time['started_at'] = MailController::convertUserTimezoneToUtc0(MailController::arrayIfNull($data, ['G00000_35', 'C00700_36']));
            $work_time['finished_at'] = MailController::convertUserTimezoneToUtc0(MailController::arrayIfNull($data, ['G00000_35', 'C00700_37']));
            $work_time['total'] = $this->arrayIfNull($data, ['G00000_35', 'C00100_38']);
            $work_time['remark'] = MailController::arrayIfNull($data, ['G00000_35', 'C00100_39']);
