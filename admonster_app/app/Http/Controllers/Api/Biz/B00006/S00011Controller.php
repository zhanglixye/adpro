...
class S00011Controller extends BaseController
{
    ...
    const CONTENT_NODE_KEY_MAIL_REMARK = 'C00100_39';
    /** @var string ファイルID */
    ...
    public function saveExpenseData(Request $request)
    {
        ...
        try {
            ...
            $work_time['started_at'] = MailController::convertUserTimezoneToUtc0(MailController::arrayIfNull($data, [self::CONTENT_NODE_KEY_MAIL_WORKTIME,self::CONTENT_NODE_KEY_MAIL_WORKTIME_STARTED_AT]));
            $work_time['finished_at'] = MailController::convertUserTimezoneToUtc0(MailController::arrayIfNull($data, [self::CONTENT_NODE_KEY_MAIL_WORKTIME,self::CONTENT_NODE_KEY_MAIL_WORKTIME_FINISHED_AT]));
            ...
            $work_time['remark'] = MailController::arrayIfNull($data, [self::CONTENT_NODE_KEY_MAIL_WORKTIME,self::CONTENT_NODE_KEY_MAIL_REMARK]);
