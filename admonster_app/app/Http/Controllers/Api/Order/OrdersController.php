...
class OrdersController extends Controller
{
    ...
    public function edit(Request $req): JsonResponse
    {
        ...
        try {
            ...
            $custom_statuses = DB::table('custom_statuses')
                ...
                ->leftJoin('order_details_related_custom_status_attributes', function ($join) {
                    $join->on('custom_statuses.id', '=', 'order_details_related_custom_status_attributes.custom_status_id')
                        ->whereNotNull('order_details_related_custom_status_attributes.custom_status_attribute_id');
                })
    ...
    public function update(Request $req): JsonResponse
    {
        ...
        try {
            ...
            // custom_status_attributesが論理削除された場合、関連するレコードの更新
            DB::table('order_details_related_custom_status_attributes')
                ...
                ->update([
                    'custom_status_attribute_id' => null,
                    'updated_at' => $register_time,
                    'updated_user_id' => $user->id
                ]);
