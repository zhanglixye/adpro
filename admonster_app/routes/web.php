...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['prefix' => 'api', 'as' => 'api', 'namespace' => 'Api'], function () {
        ...
        Route::group(['prefix' => 'utilities', 'as' => 'utilities'], function () {
            ...
            // 一時ファイルをS3にアップロード
            Route::post('/upload_from_temporary_file_to_s3', 'UtilitiesController@uploadFromTemporaryFileToS3')->name('.upload_from_temporary_file_to_s3');
            // S3のファイルを削除
            Route::post('/deleted_s3_file', 'UtilitiesController@deletedS3File')->name('.deleted_s3_file');
        });
        ...
        Route::group(['prefix' => 'order', 'as' => 'order', 'namespace' => 'Order'], function () {
            ...
            Route::group(['prefix' => 'order_details', 'as' => 'order_details'], function () {
                ...
                // 一括削除
                Route::post('bulk_delete', 'OrderDetailsController@bulkDelete')->name('.bulk_delete');
                // 案件ファイルのDL
                ...
                // システム項目の保存
                Route::post('/save_system_items', 'OrderDetailsController@saveSystemItems')->name('.save_system_items');
                // 依頼作成
                ...
                // 案件明細一括変更
                Route::post('/bulk_update_order_detail', 'OrderDetailsController@bulkUpdateOrderDetail')->name('.bulk_update_order_detail');
                // 依頼取得
